    ...
    try:
        ...
        if user.status == "kicked":
            await bot.send_message(
                ...
                text="You Are Ban To Use Me. Contact My [movies villa](https://www.telegram.dog/movies_villa_backup).",
                parse_mode="markdown",
        ...
        await bot.send_message(
            chat_id=cmd.from_user.id,
            text="Somthing Went Wrong. Contact My [movies villa support channel](https://www.telegram.dog/MOVIES_VILLA_UPDATE).",
            parse_mode="markdown",
            disable_web_page_preview=True
        )
        return 400
